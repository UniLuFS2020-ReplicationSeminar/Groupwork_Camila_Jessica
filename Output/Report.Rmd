...
# Load data
framingham_data <- read.csv("data/data_origin/framingham.csv") 
...
* ## Cleaning the Data
We pre-processed the Framingham dataset, addressing missing values (NA's) to ensure they don't influence our analysis, reducing our observations from 4240 to 3658. Renamed the dependent variable from 'PrevalentHYP' to 'pHyp' for clarity, and changed 'male' to 'gender', representing 0 as female (F) and 1 as male (M). Finally, we removed unnecessary binary variables such as 'currentSmoker', 'BPMeds', 'prevalentStroke', 'diabetes', and 'TenYearCHD'.
